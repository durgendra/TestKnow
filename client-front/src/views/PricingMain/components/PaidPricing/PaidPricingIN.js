...
const mock = [
  {
    ...
    price: { monthly: '₹199', annual: '₹1,999' },
    priceForm: {
...
const PaidPricingIN = () => {
  ...
  useEffect(() => {
    ...
    //   script1.async = true;
    //   script1.dataset.subscription_button_id = 'pl_NV4LQAzoRWoVkA';
    //   rzpPaymentForm1.appendChild(script1);
    // }
    if (!rzpPaymentForm2.hasChildNodes()) {
      // console.log(rzpPaymentForm2);
            ...
            <Grid item xs={12} md={6} key={i}>
              ...
              >
                ...
                <CardActions sx={{ justifyContent: 'flex-end', padding: 4 }}>
                  {/* {pricingOption === 'monthly' ? ( */}
                  <form id={item.priceForm.monthly}></form>
                  {/* ) : ( */}
                  {/* <form id={item.priceForm.annual}></form> */}
                  {/* )} */}
                  {/* <form id={item.priceForm.annual}></form> */}
                </CardActions>
              </Box>

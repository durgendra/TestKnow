...
const mock = [
  ...
  //   label: 'India Office',
  //   value:
  //     'OrbitalFly AI Pvt. Ltd., E-012/2F, Centurian Park-Low rise & O2 valley, Plot GH-05, Techzone-4, Greater Noida, UP 201306',
  //   icon: (
  //     <svg
  //       width={20}
  //       height={20}
  ...
  // {
  //   label: 'USA Office',
  //   value: 'Meadowview Ln, Twin Falls, ID 83301',
  //   icon: (
  //     <svg
  //       width={20}
  //       height={20}

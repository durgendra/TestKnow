  ...
  return (
    <Box>
      <Box paddingX={{ xs: 0, sm: 4, md: 6 }}>
        <Typography>
          <strong>WELCOME TO TESTKNOW</strong>
        </Typography>
        <br></br>
        <Typography>
          Thank you for using the TestKnow platform and the products, services
          and features we make available to you as part of the platform
          (collectively, the “Service”). The Service allows you to request,
          discover, watch and share videos and other content, and acts as a
          ...
          an entity (“user” or “you”) and TestKnow LLC and its affiliated
          companies (collectively, “Company” or “we” or “us” or “our”),
          concerning your access to and use of the https://www.TestKnow.co
        ...
        <Typography>
          ...
          persons who choose to access the Website from other locations do so on
        ...
        <Typography>
          ...
          ALSO BY CONTINUING TO USE THE WEBSITE. IF YOU DO NOT AGREE TO ABIDE BY
        ...
        <Typography>
          ...
          and other sounds), graphics, photos, text (such as requests, topics,
          comments and scripts), location details of videos, branding (including
          trade names, trademarks, service marks, or logos), interactive
          features, software, metrics, and other materials whether provided or
          uploaded by you, TestKnow or a third-party (collectively, "Content”).
        </Typography>
        <br></br>
        <Typography>
          Content is the responsibility of the person or entity that provides it
          to the Service. TestKnow is under no obligation to host or serve
          Content. If you see any Content you believe does not comply with this
          Agreement, including by violating the law, you can report it to us by
          emailing at example@gmail.com. Our Privacy Policy explains how we
          treat your personal data and protect your privacy when you use the
          Service.{' '}
        </Typography>
        <br></br>
        <Typography>
        ...
        <Typography>
          D. you are not a minor in the jurisdiction in which you reside, or if
          a minor, you have received parental permission to use this Website;
          and
        </Typography>

        <Typography>
          E. your use of the Company Services does not violate any applicable
          law or regulation.
        </Typography>
        ...
        <br></br>
        <Typography>
          The Website may invite you to upload profile picture, videos, provide
          location details of videos, chat, participate in blogs, message
          ...
          publish, distribute or broadcast content and materials to Company
          and/or to or via the Website, including, without limitation, text,
          writings, video, audio, photographs, graphics, locations, comments,
          ...
          Company will be treated as non-confidential and non-proprietary. When
          you create or make available a Contribution, you thereby represent and
          warrant that:
        </Typography>

        <Typography>
          A. the creation, distribution, transmission, public display and
          performance, accessing, downloading and copying of your Contribution
          does not and will not infringe the proprietary rights, including but
        ...
        <Typography>
          ...
          Company and the Website users to use your Contributions as necessary
        ...
        <Typography>
          ...
          and every identifiable individual person in the Contribution to use
        ...
        <Typography>
          ...
          Company), libelous or slanderous, does not ridicule, mock, disparage,
          intimidate or abuse anyone, does not advocate the violent overthrow of
          any government, does not incite, encourage or threaten physical harm
        ...
        <Typography>
          ...
          information from anyone under 13 or exploit people under the age of 18
          in a sexual or violent manner, and does not violate any federal or
        ...
        <Typography>
          ...
          that violates, any provision of this Agreement or any applicable law
          or regulation.
        </Typography>
        <br></br>
        <Typography>
        ...
        <br></br>
        <Typography>
          Company may accept, reject or remove reviews and comments in its sole
          discretion. Company has absolutely no obligation to screen reviews or
          to delete reviews, even if anyone considers reviews objectionable or
          inaccurate. Those persons posting reviews should comply with the
          following criteria: (1) reviewers should have firsthand experience
          with the person/entity being reviewed; (2) reviews should not contain:
          ...
          endorsed by Company, and do not represent the views of Company or of
          any affiliate or partner of Company. Company does not assume liability
          for any review or for any claims, liabilities or losses resulting from
          any review. By posting a review, the reviewer hereby grants to Company
          a perpetual, non-exclusive, worldwide, royalty-free, fully-paid,
          assignable and sublicensable license to Company to reproduce, modify,
        ...
        <Typography>
          ...
          your Third Party Account login information through the Website; or
          (ii) allowing Company to access your Third Party Account, as is
          ...
          to disclose your Third Party Account login information to Company
          and/or grant Company access to your Third Party Account (including,
          ...
          Company to pay any fees or making Company subject to any usage
          limitations imposed by such third party service providers. By granting
          Company access to any Third Party Accounts, you understand that (i)
          ...
          through the Website via your account, including without limitation any
          ...
          may be available on and through your account on the Website. Please
          ...
          on the Website and your Third Party Accounts at any time. PLEASE NOTE
          ...
          AGREEMENT(S) WITH SUCH THIRD PARTY SERVICE PROVIDERS. Company makes no
          ...
          Company is not responsible for any Social Network Content. You
          ...
          registered to use the Website. At your request made via email to our
          email address listed below, or through your account settings (if
          applicable), Company will deactivate the connection between the
          Website and your Third Party Account and delete any information stored
          on Company’s servers that was obtained through such Third Party
        ...
        <Typography>
          ...
          Services ("Submissions") provided by you to Company are
        ...
        <Typography>
          Uploading Content: If you choose to upload your Content, you must not
          upload to the Service any Content that does not comply with this
          Agreement or the law. For example, the Content you upload must not
          include third-party intellectual property (such as copyrighted
          material) unless you have permission from that party or are otherwise
          legally entitled to do so. You are legally responsible for the Content
          you submit to the Service. We may use a manual review or an automated
          system that analyzes your Content to help detect infringement and
          abuse, such as spam, malware, and illegal content. TestKnow will have
          the sole right to determine what Content gets uploaded to the Service
        ...
        <Typography>
          You retain ownership rights to your Content. However, we do require
          you to grant certain rights to TestKnow and other users of the
          Service, as described below.
        </Typography>

        <Typography>
          <strong>License to TestKnow</strong>
        </Typography>

        <Typography>
          By providing Content to the Service and by uploading profile pictures,
          videos or any media, you grant to TestKnow a worldwide, non-exclusive,
          ...
          display and perform it) in connection with the Service and TestKnow’s
          (and its successors' and Affiliates') business, including for the
          purpose of promoting and redistributing part or all of the Service.
          You grant to TestKnow a worldwide, non-exclusive, royalty-free,
          sublicensable and transferable license to use you profile picture to
          develop a picture collage with other users on the platform and
          distribute the picture collage to you and other users on the platform.
        </Typography>
        ...
        <Typography>
          ...
          a feature of the Service (such as video playback, embeds and social
          sharing). For clarity, this license does not grant any rights or
          permissions for a user to make use of your Content independent of the
          Service. You grant your friends ("followers", "people you follow" and
          people who joined the platform using your referral link) and users of
          the Service to use your profile picture in a photo collage for
        ...
        <Typography>
          The licenses granted by you continue for a commercially reasonable
          period of time after you remove or delete your Content from the
          Service. You understand and agree, however, that TestKnow may retain,
        ...
        <Typography>
          You may use the delete button provided on the website or request the
          removal of your Content from the Service at any time by emailing
          support@TestKnow.co. You must request removal of your Content if you
          no longer have the rights required by these terms. Even though we may
          delete a Content from the Website or the Content is not accessible by
          website users, a copy of the Content could still be present in our
          database server or cloud storage services provided by third parties.{' '}
        </Typography>

        <Typography>
          <strong>Removal of Content By TestKnow</strong>
        </Typography>

        <Typography>
          If we reasonably believe that any Content is in breach of this
          Agreement or may cause harm to TestKnow, our users, or third parties,
          we may remove or take down that Content in our discretion.{' '}
        </Typography>
        ...
        <Typography>
          ...
          please email us at support@TestKnow.co
        </Typography>
        <br></br>
        <Typography>
        ...
        <Typography>
          ...
          as you comply with this Agreement and applicable law. You may view or
          listen to Content for your personal, non-commercial use. You may not
          access or use the Website for any other purpose other than that for
          which Company makes it available. The Website may not be used in
        ...
        <Typography>
          D. deciphering, decompiling, disassembling or reverse engineering any
          of the software comprising or in any way making up a part of the
          Website{' '}
        </Typography>

        <Typography>
          E. deleting the copyright or other proprietary rights notice from any
          Website content{' '}
        </Typography>

        <Typography>
          F. engaging in any automated use of the system, such as using any data
          mining, robots or similar data gathering and extraction tools{' '}
        </Typography>

        <Typography>
          G. except as may be the result of standard search engine or Internet
        ...
        <Typography>
          I. interfering with, disrupting, or creating an undue burden on the
          Website or the networks or services connected to the Website{' '}
        </Typography>

        <Typography>
          J. making any unauthorized use of the Company Services, including
        ...
        <Typography>
          L. systematic retrieval of data or other content from the Website to
        ...
        <Typography>
          N. using any information obtained from the Website in order to harass,
          abuse, or harm another person{' '}
        </Typography>

        <Typography>
          O. using the Company Services as part of any effort to compete with
        ...
        <Typography>
          ...
          interfere with any part of the Service (or attempt to do any of these
          things), including security-related features or features that (a)
          prevent or restrict the copying or other use of Content or (b) limit
          the use of the Service or Content;
        </Typography>

        <Typography>
          R. access the Service using any automated means (such as robots,
          botnets or scrapers) except (a) in the case of public search engines,
          in accordance with TestKnow’s robots.txt file; or (b) with TestKnow’s
          prior written permission;{' '}
        </Typography>

        <Typography>
          S. collect or harvest any information that might identify a person(s){' '}
        </Typography>

        <Typography>
          T. use the Service to distribute unsolicited promotional or commercial
          content or other unwanted or mass solicitations;
        </Typography>

        <Typography>
          U. cause or encourage any inaccurate measurements of genuine user
          engagement with the Service, or otherwise manipulate metrics in any
          manner;
        </Typography>

        <Typography>
          W. misuse any reporting, flagging, complaint, dispute, or appeals
        ...
        <Typography>
          ...
          personal, non-commercial use (for example, you may not publicly screen
          videos or stream music from the Service); or
        </Typography>
        ...
        <Typography>
          ...
          Company graphics, logos, designs, page headers, button icons, scripts
        ...
        <Typography>
          ...
          respective owners. Provided that you are eligible to use the Website,
          you are granted a limited license to access and use the Website and
          the Company Content and to download or print a copy of any portion of
          the Company Content to which you have properly gained access solely
        ...
        <Typography>
          ...
          any Third Party Websites accessed through the Website or any Third
          Party Content posted on, available through or installed from the
          ...
          Website or any Third Party Content does not imply approval or
          endorsement thereof by us. If you decide to leave the Website and
          ...
          any website to which you navigate from the Website or relating to any
          applications you use or install from the Website. Any purchases you
          make through Third Party Websites will be through other websites and
          from other companies, and Company takes no responsibility whatsoever
          in relation to such purchases which are exclusively between you and
        ...
        <Typography>
          B. take appropriate legal action against anyone who, in Company’s sole
          discretion, violates this Agreement, including without limitation,
        ...
        <Typography>
          E. otherwise manage the Website in a manner designed to protect the
        ...
        <Typography>
          ...
          Website or are otherwise a user or member of the Website, as
        ...
        <Typography>
          ...
          changes to this Agreement will be posted on the Website and revisions
          ...
          that you will periodically check the Website for updates to this
        ...
        <Typography>
          ...
          and any third party, you understand and agree that Company is under no
        ...
        <Typography>
          ...
          all aspects of the Website and Company Services shall be governed by
          and construed in accordance with the internal laws of the State of
          Illinois, without regard to conflict of law provisions. With respect
          ...
          and federal courts located in State of Illinois, USA, and you hereby
          ...
          related in any way to the Website or Company Services be instituted
        ...
        <Typography>
          ...
          arbitration or court proceeding. Such informal negotiations commence
          upon written notice from one person to the other.
        </Typography>

        <Typography>
          <strong>C. Binding Arbitration.</strong> If you and Company are unable
          to resolve a Dispute through informal negotiations, either you or
          Company may elect to have the Dispute (except those Disputes expressly
          excluded below) finally and exclusively resolved by binding
          arbitration. Any election to arbitrate by one party shall be final and
          binding on the other. YOU UNDERSTAND THAT ABSENT THIS PROVISION, YOU
          ...
          at the AAA website www.adr.org. The determination of whether a Dispute
          ...
          to be excessive, Company will pay all arbitration fees and expenses.
          ...
          by a party. The arbitrator must follow applicable law, and any award
          ...
          arbitration will take place in State of Illinois, USA. Except as
          otherwise provided in this Agreement, you and Company may litigate in
        ...
        <Typography>
          ...
          shall be joined with any other; (2) there is no right or authority for
          any Dispute to be arbitrated on a class-action basis or to utilize
          class action procedures; and (3) there is no right or authority for
        ...
        <Typography>
          ...
          and (3) any claim for injunctive relief. If this Section is found to
          be illegal or unenforceable then neither you nor Company will elect to
          arbitrate any Dispute falling within that portion of this Section
        ...
        <Typography>
          ...
          CONTENT OR THE CONTENT OF ANY WEBSITES LINKED TO THIS WEBSITE AND
          ...
          TO AND USE OF OUR WEBSITE, (C) ANY UNAUTHORIZED ACCESS TO OR USE OF
          ...
          CESSATION OF TRANSMISSION TO OR FROM THE WEBSITE OR COMPANY SERVICES,
          (E) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE
          TRANSMITTED TO OR THROUGH THE WEBSITE BY ANY THIRD PARTY, AND/OR (F)
          ...
          BANNER OR OTHER ADVERTISING, AND COMPANY WILL NOT BE A PARTY TO OR IN
        ...
        <Typography>
          ...
          Website for the purpose of the performance of the Company Services, as
          well as data relating to your use of the Company Services. Although we
          perform regular routine backups of data, you are primarily responsible
          for all data that you have transferred or that relates to any activity
          you have undertaken using the Company Services. You agree that Company
        ...
        <Typography>
          Users are allowed on TestKnow to transmit and receive valid electronic
          signatures in the United States under the Electronic Signatures in
          Global and National Commerce Act (E-Sign Act) of 2000 and the Uniform
          Electronic Transactions Act (UETA) of 1999 as adopted by individual
          states. Users’ signatures and identities are not authenticated on
          TestKnow.
        </Typography>
        <br></br>
        ...
        <Typography>
          We at TestKnow strive to ensure your satisfaction with our digital
          software service. If you are not entirely satisfied with your
          purchase, we offer a 7 days money-back guarantee, starting from the
          date of purchase. To request a refund, please contact our customer
          support team at support@testknow.co within the specified refund
          period. Refunds are subject to the following conditions: The request
          for a refund must be made within the specified refund period. The
          software license or subscription must have been purchased directly
          from TestKnow. Refunds are processed within a reasonable time frame
          and will be issued to the original payment method used for the
          purchase. Any promotional discounts applied at the time of purchase
          will be deducted from the refunded amount. Refunds may take several
          business days to appear on your statement, depending on your financial
          institution.
        </Typography>
        ...
        <Typography>
          Users may cancel their subscription or service at any time by
          accessing their account settings or by contacting our customer support
          team. Upon cancellation: Access to the digital software service will
          be available until the end of the current billing cycle. No further
          charges will be applied after the cancellation date. We do not provide
          partial refunds for unused portions of the subscription or service.
        </Typography>

        <Typography>
          <strong>Changes to Refunds and Cancellation Policy</strong>
        </Typography>

        <Typography>
          TestKnow reserves the right to modify or update the Refunds and
          Cancellation Policy at any time. Users will be notified of any
          changes, and continued use of the service after such modifications
        ...
        <Typography>
          ...
          of the Website and Company Services. Upon Company’s request, you will
        ...
        <Typography>
          If you have any questions or require assistance regarding our Refunds
          and Cancellation Policy, please contact our customer support team. In
          order to resolve a complaint regarding the Company Services or to

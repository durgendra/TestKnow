...
import {
  ...
  DailyKTs as DailyKTsView,
  DailyKTSingle as DailyKTSingleView,
  DailyKTSingleID as DailyKTSingleID,
} from 'views';
...
const routes = [
  ...
  {
    path: '/',
    renderer: (params = {}) => <FrontPage {...params} />,
  },
  {
    path: '/daily',
    renderer: (params = {}) => <DailyKTsView {...params} />,
  },
  {
    path: '/dailykt',
    renderer: (params = {}) => <DailyKTSingleView {...params} />,
  },
  {
    path: '/dailyktnew/:dailyktId',
    renderer: (params = {}) => <DailyKTSingleID {...params} />,
  },
  {
    path: '/termsofservice',
    renderer: (params = {}) => <TermsConditions {...params} />,
  },
  {
    path: '/privacy',
    renderer: (params = {}) => <Privacy {...params} />,
  },
  // {
  //   path: '/home',

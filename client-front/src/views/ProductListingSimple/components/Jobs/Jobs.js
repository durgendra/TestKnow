...
export const mock = [
  {
    title: 'Find Competitive Products',
    location: 'Madrid',
    type: 'Remote',
    team: 'Consumer',
  ...
  {
    title: 'Generate product ideas and concepts',
    location: 'Yerevan',
    type: 'Part time',
    team: 'Consumer',
    subtitle: 'Help us make the best decisions with qualitative experiments.',
  ...
  {
    title: 'Create product launch press release',
    location: 'Paris',
    type: 'Full time',
    team: 'Consulting',
    subtitle: 'Responsible for creating life in our apps.',
